...
namespace opengldrv {
	...
	OGLVertexstream::OGLVertexstream(const ovis_uint32 numVertices,
	const video::Vertexformat& format,const ovis_uint32 flags,video::Vertexstream::Vertexsource *pSource):
	Vertexstream(format,numVertices,pSource),m_pBuffer(new BufferObject(GL_ARRAY_BUFFER_ARB)),m_IsDataOK(true)
	{
		GLenum usage;
